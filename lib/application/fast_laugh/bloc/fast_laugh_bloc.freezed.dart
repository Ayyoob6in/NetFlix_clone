...
mixin _$FastLaughState {
  List<Downloads> get videosLoist =>
      throw _privateConstructorUsedError; //required List<int>likedVediosId,
...
abstract class $FastLaughStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Downloads> videosLoist, bool isLoading, bool isError});
}
...
class _$FastLaughStateCopyWithImpl<$Res, $Val extends FastLaughState>
  ...
  @override
  $Res call({
    Object? videosLoist = null,
    Object? isLoading = null,
    Object? isError = null,
  }) {
    return _then(_value.copyWith(
      videosLoist: null == videosLoist
          ? _value.videosLoist
          : videosLoist // ignore: cast_nullable_to_non_nullable
              as List<Downloads>,
...
class _$InitialImpl implements _Initial {
  const _$InitialImpl(
      {required final List<Downloads> videosLoist,
      required this.isLoading,
      required this.isError})
      : _videosLoist = videosLoist;

  final List<Downloads> _videosLoist;
  @override
  List<Downloads> get videosLoist {
    if (_videosLoist is EqualUnmodifiableListView) return _videosLoist;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_videosLoist);
  }
...
//required List<int>likedVediosId,
  ...
  @override
  String toString() {
    return 'FastLaughState(videosLoist: $videosLoist, isLoading: $isLoading, isError: $isError)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._videosLoist, _videosLoist) &&
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_videosLoist), isLoading, isError);
...
abstract class _Initial implements FastLaughState {
  ...
  @override
  List<Downloads> get videosLoist;
  @override //required List<int>likedVediosId,
  bool get isLoading;
  @override
  bool get isError;
  @override
